...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7050622921:AAFbGmJxnN_VhEb1MXxZJSk6rD6S-yLslDk")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "tony_terabot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "23054736"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "d538c2e1a687d414f5c3dce7bf4a743c")
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://movie:movie@movie.wtnh2cy.mongodb.net/?retryWrites=true&w=majority")
